        ...
        <g id="Aperture">
          <g id="Aperture_Icon" className="cls-2">
            <a
              ...
              href="https://clients.thischristography.com/?t=graduates"
              target="_blank"
              rel="noreferrer noopener"
              id="Graduates"
              onMouseEnter={() => setActiveLabel("Graduates")}
              onMouseLeave={() => setActiveLabel(null)}
            >
              <clipPath id="cp-graduates">
              ...
              <g transform="matrix(1 0 0 1 0 2.384186e-07)" style={{ clipPath: 'url(#cp-graduates)' }}>
                <image
                  xlinkHref="/assets/home/desktop/graduates.jpg"
                  transform="matrix(2.236315e-02 0 0 2.236315e-02 50.3996 3.6233)"
                  filter={activeLabel === "Graduates" ? "" : "url(#grayscale)"} />
              </g>
            </a>
            <a
              className="primary-page-link"
              href="https://clients.thischristography.com/?t=portraits"
              target="_blank"
              rel="noreferrer noopener"
              id="Portraits"
              onMouseEnter={() => setActiveLabel("Portraits")}
              onMouseLeave={() => setActiveLabel(null)}
            >
              ...
              <g transform="matrix(1 0 0 1 0 4.768372e-07)" style={{ clipPath: 'url(#cp-portraits)' }}>
                <image
                  xlinkHref="/assets/home/desktop/portraits.jpg"
            ...
            <a
              className="primary-page-link"
              href="https://clients.thischristography.com/?t=wedding"
              target="_blank"
              rel="noreferrer noopener"
              id="Weddings"
              onMouseEnter={() => setActiveLabel("Weddings")}
              onMouseLeave={() => setActiveLabel(null)}
            >
              ...
              <g style={{ clipPath: 'url(#cp-weddings)' }}>
                <image
                  xlinkHref="/assets/home/desktop/weddings.jpg"
            ...
            <a
              className="primary-page-link"
              href="https://clients.thischristography.com/automotive/"
              target="_blank"
              rel="noreferrer noopener"
              id="Automotive"
              onMouseEnter={() => setActiveLabel("Automotive")}
              onMouseLeave={() => setActiveLabel(null)}
            >
              ...
              <g style={{ clipPath: 'url(#cp-automotive)' }}>
                <image
                  xlinkHref="/assets/home/desktop/automotive.jpg"
            ...
            <a
              className="primary-page-link"
              href="https://clients.thischristography.com/?t=gallery"
              target="_blank"
              rel="noreferrer noopener"
              id="Galleries"
              onMouseEnter={() => setActiveLabel("Galleries")}
              onMouseLeave={() => setActiveLabel(null)}
            >
