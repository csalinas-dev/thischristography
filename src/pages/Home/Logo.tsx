      ...
      <svg version="1.1" id="icon" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <g id="Aperture">
          <g id="Aperture_Icon" className="cls-2">
            <Link to="/galleries" id="Boudoir" onMouseEnter={() => setActiveLabel("Galleries")} onMouseLeave={() => setActiveLabel(null)}>
              <clipPath id="cp-boudoir">
              ...
              <g style={{ clipPath: 'url(#cp-boudoir)' }}>
                <image xlinkHref="/assets/images/galleries/balloon-fiesta/ThisChristography-20191013.jpg" transform="matrix(1.238889e-02 0 0 1.238889e-02 41.7222 38.125)"></image>
              </g>
            </Link>
            <Link to="/automotive" id="Automotive" onMouseEnter={() => setActiveLabel("Automotive")} onMouseLeave={() => setActiveLabel(null)}>
              ...
              <g style={{ clipPath: 'url(#cp-automotive)' }}>
                <image xlinkHref="/assets/images/automotive/ThisChristography-20190101-003.jpg" transform="matrix(2.017041e-02 0 0 2.017041e-02 44.7444 37.5291)"></image>
              </g>
            </Link>
            <Link to="/weddings" id="Weddings" onMouseEnter={() => setActiveLabel("Weddings")} onMouseLeave={() => setActiveLabel(null)}>
              ...
              <g style={{ clipPath: 'url(#cp-weddings)' }}>
                <image xlinkHref="/assets/images/weddings/ThisChristography-20190724-52.jpg" transform="matrix(2.411111e-02 0 0 2.411111e-02 56.9309 26.1667)"></image>
              </g>
            </Link>
            <Link to="/portraits" id="Portraits" onMouseEnter={() => setActiveLabel("Portraits")} onMouseLeave={() => setActiveLabel(null)}>
              ...
              <g transform="matrix(1 0 0 1 0 4.768372e-07)" style={{ clipPath: 'url(#cp-portraits)' }}>
                <image xlinkHref="/assets/images/portraits/ThisChristography-20200201-4.jpg" transform="matrix(2.830000e-02 0 0 2.830000e-02 59.9585 7.3556)"></image>
              </g>
            </Link>
            <Link to="/galleries" id="Galleries" onMouseEnter={() => setActiveLabel("Galleries")} onMouseLeave={() => setActiveLabel(null)}>
              ...
              <g transform="matrix(1 0 0 1 0 2.384186e-07)" style={{ clipPath: 'url(#cp-galleries)' }}>
                <image xlinkHref="/assets/images/galleries/thunderbirds/ThisChristography-20190518-029.jpg" transform="matrix(2.236315e-02 0 0 2.236315e-02 50.3996 3.6233)"></image>
              </g>
            </Link>
          </g>
        </g>
